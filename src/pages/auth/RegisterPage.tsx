    ...
    return (
        ...
        >
            ...
            <div className="max-w-md w-full animate-in zoom-in duration-500 relative z-10">
                <form onSubmit={handleSubmit(onSubmit)} className="glass-card shadow-2xl p-10 space-y-6 bg-white/95 dark:bg-slate-900/95 border border-white/20 overflow-y-auto max-h-[90vh] rounded-2xl">
                    <div className="text-center space-y-2">
                        <h2 className="text-3xl font-black text-healthcare-dark tracking-tight">Join TangaCare</h2>
                        <p className="text-slate-400 font-bold text-xs">Create your pharmacy staff account</p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 text-left">
                        <div className="space-y-1.5">
                            ...
                            />
                            {errors.first_name && <p className="text-[9px] font-normal text-red-500">{errors.first_name.message}</p>}
                        </div>
                        <div className="space-y-1.5">
                            ...
                            />
                            {errors.last_name && <p className="text-[9px] font-normal text-red-500">{errors.last_name.message}</p>}
                        </div>
                    </div>
                    ...
                    <div className="space-y-4 text-left">
                        <div className="space-y-1.5">
                            ...
                            />
                            {errors.email && <p className="text-[9px] font-normal text-red-500">{errors.email.message}</p>}
                        </div>
                        <div className="space-y-1.5">
                        ...
                        <div className="space-y-1.5">
                            ...
                            {errors.password && <p className="text-[9px] font-normal text-red-500">{errors.password.message}</p>}
                        </div>
                    </div>
                    ...
                    <div className="text-center">
                        <button type="button" onClick={() => navigate({ to: '/auth/login' })} className="text-xs font-bold text-healthcare-primary hover:underline flex items-center justify-center mx-auto gap-1">
