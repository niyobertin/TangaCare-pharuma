                                ...
                                >
                                    <div className="flex-1 flex flex-col justify-center">
                                        ...
                                        <span className="text-[10px] text-slate-400 font-bold uppercase mt-0.5">
                                            RWF {item.selling_price.toLocaleString()}
                                        </span>
                                    </div>
                                    <div className="flex items-center gap-3">
                                        <div className="flex items-center border border-slate-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-900 overflow-hidden shadow-sm">
                                            <button
                                                ...
                                                className="p-1 px-2 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors text-slate-400 hover:text-healthcare-primary"
                                            >
                                                <Minus size={12} />
                                            </button>
                            ...
                            <div className="h-full flex flex-col items-center justify-center py-20 text-center space-y-4">
                                ...
                                <div className="p-2">
                                    ...
                                    <p className="text-[10px] text-slate-300 mt-1">
                                        Search and select items to start dispensing
                                    </p>
                                </div>
                            </div>
                        )}
                    ...
                    <div className="mt-auto space-y-6 pt-6 border-t border-slate-100 dark:border-slate-800">
                        <div className="flex gap-2">
                            <button
                                ...
                                className={cn(
                                    ...
                                    paymentMethod === 'Cash'
                                        ? 'bg-healthcare-primary border-healthcare-primary text-white shadow-lg shadow-teal-500/20'
                        ...
                        >
                            {processing ? (
                                ...
                                <>
                                    <Receipt size={18} /> Complete Dispensing
                                </>
                            )}
                        </button>
                    </div>
                    ...
                    {showSuccess && (
                        <div className="absolute inset-0 bg-white/95 dark:bg-slate-900/95 z-20 flex flex-col items-center justify-center p-8 text-center animate-in fade-in duration-300 rounded-2xl">
                            ...
                            <p className="text-xs text-slate-400 font-bold mt-2 uppercase tracking-widest">
                                Generating receipt & updating stock
                            </p>
                        </div>
                    )}
                </div>
