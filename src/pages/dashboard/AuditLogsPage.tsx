...
const DUMMY_LOGS: AuditLog[] = [
    {
        ...
        module: 'Facilities',
        timestamp: '2026-01-17 14:20:05',
        details: 'Created "Kigali King Faisal Hospital"',
        impact: 'High',
    },
    {
        id: 'LOG-002',
        ...
        module: 'Dispensing',
        timestamp: '2026-01-17 15:10:42',
        details: 'Dispensed 2x Amoxicillin 500mg',
        impact: 'Low',
    },
    {
        id: 'LOG-003',
        ...
        action: 'ADJUST_STOCK',
        module: 'Stock',
        timestamp: '2026-01-17 15:45:12',
        details: 'Adjusted stock for Paracetamol - Corrected count',
        impact: 'Medium',
    },
    {
        id: 'LOG-004',
        ...
        action: 'APPROVE_PO',
        module: 'Procurement',
        timestamp: '2026-01-17 16:05:33',
        details: 'Approved PO-2026-003 for Biotech Rwanda',
        impact: 'High',
    },
    {
        id: 'LOG-005',
        ...
        details: 'Low stock alert for Insulin Glargine',
        impact: 'Medium',
    },
];
                            ...
                            <div className="flex flex-col md:flex-row gap-4 md:items-center">
                                ...
                                <div
                                    className={cn(
                                        ...
                                        log.module === 'Facilities'
                                            ? 'bg-blue-50 text-blue-500'
                                            : log.module === 'Dispensing'
                                              ? 'bg-teal-50 text-teal-500'
                                              : log.module === 'Stock'
                                                ? 'bg-indigo-50 text-indigo-500'
                                                : log.module === 'Procurement'
                                ...
                                <div className="flex-1 space-y-1">
                                    <div className="flex justify-between items-start">
                                        <h4 className="font-black text-healthcare-dark text-sm">
                                            {log.action}
                                        </h4>
