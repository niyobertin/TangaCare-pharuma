...
export function OrdersPage() {
    ...
    const getStatusColor = (status: string) => {
        switch (status) {
            ...
            case 'RECEIVED':
                return 'bg-emerald-50 text-emerald-600 border-emerald-100'; // Full received
            case 'PARTIAL':
                                    ...
                                    orders.map((order) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4">
                                                <span
                                                    className={`px-2.5 py-1 rounded-md text-[10px] font-black uppercase tracking-wide border ${getStatusColor(order.status)}`}
                                                >
                                                    {order.status}
                                                </span>
                                            </td>
