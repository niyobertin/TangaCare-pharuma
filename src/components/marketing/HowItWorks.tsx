...
const steps = [
    {
        ...
        description: "Import your existing stock list via Excel or connect directly to your suppliers.",
        icon: Box,
    },
    {
        number: "02",
        title: "Track in Real-Time",
        description: "Every sale updates your stock instantly. Low stock alerts trigger automatically.",
        icon: Settings,
    },
    {
        number: "03",
        ...
        <section id="how-it-works" className="py-24 bg-white dark:bg-black relative overflow-hidden">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center mb-20">
                    <h2 className="text-base font-semibold text-teal-600 tracking-wide uppercase">How It Works</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
                    ...
                    {steps.map((step, i) => (
                        ...
                        >
                            ...
                            <p className="text-gray-500 dark:text-zinc-400 max-w-xs text-sm leading-relaxed">{step.description}</p>
                        </motion.div>
                    ))}
                </div>
            </div>
