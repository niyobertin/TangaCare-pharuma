...
const plans = [
    {
        ...
        features: ["Up to 1,000 items", "Basic Inventory Tracking", "Expiry Alerts", "1 User Account", "Email Support"],
    },
    {
        name: "Pro",
        price: "79",
        ...
        <section id="pricing" className="py-24 bg-white dark:bg-black">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    ...
                    <p className="mt-4 text-gray-500 dark:text-zinc-400">No hidden fees. Cancel anytime.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {plans.map((plan) => (
                        ...
                        >
                            ...
                            <p className="mt-3 text-sm text-slate-600 dark:text-zinc-400 leading-relaxed font-medium">{plan.description}</p>
                            ...
                            <ul className="mt-10 space-y-4 flex-1">
                                {plan.features.map((feature) => (
                                    <li key={feature} className="flex items-start">
                                        ...
                                        <span className="text-sm text-slate-700 dark:text-zinc-300 font-medium">{feature}</span>
                                    </li>
                                ))}
                            </ul>

                            <div className="mt-10">
                                <Link to={plan.price === "Custom" ? "/" : "/auth/register"} hash={plan.price === "Custom" ? "contact" : undefined}>
                                    <Button
