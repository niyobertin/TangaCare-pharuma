...
const features = [
    {
        ...
        description: "Know exactly what you have on the shelf at any moment. Updates instantly with every sale.",
        icon: PackageCheck,
        className: "md:col-span-1",
    },
    {
        title: "Multi-Location Support",
        description: "Manage multiple pharmacies or hospital wards from a single dashboard. Centralized control.",
        icon: Building2,
        className: "md:col-span-1",
    },
    {
        title: "Smart Reordering",
        description: "AI-driven suggestions tell you exactly what to order and when, based on historical usage.",
        icon: Zap,
        className: "md:col-span-1",
    },
    {
        title: "Supplier & Procurement",
        description: "Track vendor performance, lead times, and fulfillment rates to optimize procurement.",
        icon: Truck,
        className: "md:col-span-2",
    },
    {
        title: "Patient Management",
        description: "Track patient history, manage prescriptions, and build loyalty with integrated CRM features.",
        icon: Users,
        className: "md:col-span-1",
    },
    {
        title: "Analytics & Reporting",
        description: "Comprehensive financial reports, sales trends, and ABC analysis exportable in one click.",
        icon: BarChart3,
    ...
    return (
        <section id="features" className="py-24 bg-slate-50 dark:bg-zinc-900/30 transition-colors">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    <img src="/dashboard-secondary.png" alt="TangaCare Features Preview" className="w-full object-cover" />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent"></div>
                    <div className="absolute bottom-10 left-10">
                        <p className="text-white text-2xl font-black italic tracking-tighter opacity-80 select-none">TangaCare Analytics</p>
                    </div>
                </motion.div>
            </div>
        </section>
