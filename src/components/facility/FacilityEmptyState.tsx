    ...
    return (
        <div className="h-full flex flex-col items-center justify-center p-8 bg-slate-50/50 dark:bg-slate-900/50">
            <div className="max-w-md w-full text-center space-y-6 animate-in fade-in zoom-in duration-500">
                <div className="w-24 h-24 bg-white dark:bg-slate-800 rounded-3xl shadow-xl shadow-slate-200/50 dark:shadow-none flex items-center justify-center mx-auto mb-6 transform rotate-3 hover:rotate-6 transition-transform duration-300">
