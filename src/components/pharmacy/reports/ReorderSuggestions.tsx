...
import { AlertCircle, ArrowRight, ShoppingCart, RefreshCcw } from 'lucide-react';
                        ...
                        {suggestions.map((item) => (
                            <tr key={item.medicine_id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/30 transition-colors">
                                ...
                                <td className="px-6 py-4 text-right text-slate-600 dark:text-slate-400">
                                    {item.average_daily_usage.toFixed(1)}
                                </td>
                                <td className="px-6 py-4 text-right">
                                    <div className={`inline-flex items-center gap-1 text-xs font-bold px-2 py-0.5 rounded-full ${item.days_remaining < 3
                                ...
                                <td className="px-6 py-4 text-right">
                                    <button className="text-healthcare-primary hover:text-teal-700 font-bold text-xs inline-flex items-center gap-1">
