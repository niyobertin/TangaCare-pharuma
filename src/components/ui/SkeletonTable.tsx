...
function SkeletonCell({ width = "80%", animate = true, delay = 0, align = "left" }: SkeletonCellProps) {
...
function SkeletonRow({ colCount, animate, rowIndex, density, columnAligns = [] }: SkeletonRowProps) {
...
function DataRow({ row, headers, rowIndex, density, columnAligns = [], actions, onRowClick, zebra }: DataRowProps) {
    const pad = densityMap[density]?.cell || densityMap.normal.cell;
...
export function SkeletonTable({
    ...
    const isLoading =
        loading !== undefined ? loading : !data;
                            ...
                            <thead>
                                <tr style={{ background: "#fafafa" }}>
                                    {Array.from({ length: effectiveCols }).map((_, i) => (
                                        ...
                                        >
                                            <SkeletonCell width="60%" animate={animate} delay={i * 0.08} />
                                        </th>
                                    ))}
                                </tr>
                            </thead>
                        ...
                        {!headersToShow && !isLoading && data && data.length > 0 && (
                            <thead>
                                <tr style={{ background: "#fafafa" }}>
                                    ...
                                    {actions && (
                                        <HeaderCell label="Actions" isAction />
                                    )}
                                </tr>
                            </thead>
                        )}
...
/* ================================================================
   ...
   ================================================================ */
const DEMO_DATA = [
    { id: "USR-001", name: "Amara Nwosu", role: "Engineer", status: "Active", joined: "2023-01-12" },
    { id: "USR-002", name: "Kenji Tanaka", role: "Designer", status: "Active", joined: "2023-03-08" },
    { id: "USR-003", name: "Lena Fischer", role: "Product", status: "Inactive", joined: "2022-11-30" },
    { id: "USR-004", name: "Carlos Ruiz", role: "Engineer", status: "Active", joined: "2024-02-14" },
    { id: "USR-005", name: "Yemi Adeyemi", role: "Marketing", status: "Active", joined: "2023-07-22" },
];
    ...
    return (
        ...
        >
            <div style={{ maxWidth: "860px", margin: "0 auto" }}>
                ...
                <p style={{ fontSize: "12px", color: "#aaa", marginBottom: "20px", marginTop: "-12px" }}>
                    → {phases[phase].desc}
                </p>
